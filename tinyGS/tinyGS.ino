...
//////////////////////////////////////////////
bool allow_Temperature_Compensation=true;
...
void loop() {  
  ...
  //Measure of Chip Temperature and Compensation
  //////////////////////////////////////////////
  if (allow_Temperature_Compensation){ 
    //////////////////////////////////////////////
    //Measure of Chip Temperature and Compensation
    //////////////////////////////////////////////
    now = millis();
      ...
      if ((now-last_write_temp>60000)
        ...
        if (t1!=-90.0 && t2!=-90.0 && f1!=-20000.0 && f2!=-20000.0){
            ...
            if (abs(freq_off)<frequency_deviation_limit) {
              status.modeminfo.freqOffset=-freq_off;
              //Con la nueva beta (Abril/2025) el freqOffset va en Hz (no en MHz).
            ...
            || last_log_temp==0  ) {last_log_temp=now;
                //Con la nueva beta (Abril/2025) el freqOffset va en Hz (no en MHz).
                Log::console (PSTR("Chip Ta: %2.2f ºC -> FreqOffset: %.6f Hz")
                              ,temperatura
